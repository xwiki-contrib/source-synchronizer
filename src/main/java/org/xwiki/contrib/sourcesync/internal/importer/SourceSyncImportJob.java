...
@Component
@Named(SourceSyncImportJob.JOBTYPE)
@Singleton
public class SourceSyncImportJob extends AbstractJob<SourceSyncRequest, JobStatus>
{
    /**
     * The id of the job.
     */
    public static final String JOBTYPE = "sourcesync.import";

    private SourceSyncImporter importer;
    ...
    protected void runInternal() throws Exception
    {
        ...
        try {
            ...
            for (SourceSyncExtension extension : getRequest().getExtensions()) {
                ...
                this.importer.importExtension(extension, getRequest().isForce());
            }
            ...
            for (SourceSyncDocument document : getRequest().getDocuments()) {
                ...
                this.importer.importDocument(document);
            }
        } finally {
